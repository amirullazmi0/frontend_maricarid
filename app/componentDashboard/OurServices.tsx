                ...
                <div className="lg:md:col-span-8 col-span-10 feature-left p-4 grid gap-2 h-fit">
                    ...
                    <div className="grid lg:md:grid-cols-3 gap-4">
                        <div className="card-service aspect-square p-2 grid items-center">
                            <div className="absolute cs-item flex justify-center p-2 items-center h-full">
                            ...
                            <div className="h-max ">
                                <div className="grid items-center justify-center">
                                    <Image alt='' src={planeIcon} />
                                </div>
                                <div className='text-lg font-bold text-center text-sky-950 '>
