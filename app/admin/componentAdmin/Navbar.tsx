    ...
    return (
        <div className='bg-dark'>
            <div className="flex justify-center p-2 items-center text-white gap-6">
                ...
                <button onClick={() => handleNavigation('client')} className={`hover:scale-105 active:scale-95 duration-200 pl-3 pr-3 ${active === `client` && `border-b-4 border-warning`}`}>Client</button>
